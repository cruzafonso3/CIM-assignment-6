...
% -------------------------------------------------------------------------
% INTRODUÇÃO DE DADOS (Valores Atualizados)
% -------------------------------------------------------------------------
% Ponto 2: Dados da DFT 
dft_var1 = [1, 2, 3, 4]; % Mantido do original
dft_var2 = [3, 4, 5, 5]; % Atualizado

% Ponto 3: Dados da MDCT 
mdct_var1 = [2, 2, 3, 4]; % Atualizado
mdct_var2 = [4, 5, 5, 5]; % Atualizado
