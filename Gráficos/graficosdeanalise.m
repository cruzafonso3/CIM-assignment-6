...
% -------------------------------------------------------------------------
% INTRODUÇÃO DE DADOS (Corrigido para corresponder às tabelas LaTeX)
% -------------------------------------------------------------------------
% Ponto 2: Dados da DFT 
dft_var1 = [1, 2, 3, 4]; % Notas Tabela 1 - Var I
dft_var2 = [3, 4, 5, 5]; % Notas Tabela 1 - Var II

% Ponto 3: Dados da MDCT 
mdct_var1 = [2, 2, 3, 4]; % Notas Tabela 3 - Var I
mdct_var2 = [4, 5, 5, 5]; % Notas Tabela 3 - Var II
...
disp('-> Gráficos Premium gerados com sucesso e perfeitamente alinhados com o LaTeX!');